...
interface GraphBarCardLucroProps {
  categories: string[];
...
const GraphBarCardLucro: FC<GraphBarCardLucroProps> = ({
  categories,
  seriesData,
  ...
  return (
    <Col>
      <Card className="custom-card" style={{ borderRadius: '12px', height: '324px' }}>
...
export default GraphBarCardLucro;
