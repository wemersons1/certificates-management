...
interface SecondaryDoubleCardProps {
    title1: string,
...
const SecondaryDoubleCard: FC<SecondaryDoubleCardProps> = ({title1, value1, predicted1, title2, value2, predicted2, icon, iconColor}) => {    
...
export default SecondaryDoubleCard
