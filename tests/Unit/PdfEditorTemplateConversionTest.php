...
{
    public function test_converts_pdf_page_into_editor_container_preserving_positioned_blocks(): void
    {
        $pageHtml = <<<'HTML'
<div id="page1-div" style="position:relative;width:1264px;height:893px;">
    ...
    <p style="position:absolute;top:830px;left:166px;white-space:nowrap;font-size:18px;">Espaço reservado para validação</p>
...
HTML;
        ...
        $this->assertStringContainsString('top:737.98px;left:147.48px;', $result);
